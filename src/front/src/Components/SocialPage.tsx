...
export default class SocialPage extends Component<IProps, IState> {
  constructor(props: IProps) {
    ...
    this.state = {
      ...
      addFriend: false,
      blockUser: false,
      section: sessionStorage.getItem("section") ? sessionStorage.getItem("section") : "friends",
    };
  }
  ...
  async componentDidMount(): Promise<void> {
    ...
    const elem = document.querySelector('.' + this.state.section) as HTMLElement
        ...
        <div className="friend-channel-div">
          <div className="friends"
            onClick={async () => {
              ...
              sessionStorage.setItem("section", "friends");
            }
            }
          >
            Friends
          ...
          <div className="channels"
            onClick={async () => {
              ...
              sessionStorage.setItem("section", "channels");
            }
            }
          >
            Channels
